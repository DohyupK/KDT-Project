# 멤버 단독 · reg_d90 (capacity)

최종 갱신: 2026-08-10  
모음: [`../README.md`](../README.md) · 앙상블 집계: [`../../model_quality.md`](../../model_quality.md)

이 문서는 **투표 가중 합산 전**, 멤버 `reg_d90` **단독 출력** vs CSV 실측이다.
...
| MAE | **3.7992** |
| RMSE | **4.8653** |
| Bias (pred−true) | -0.0034 |
| MAPE | 1.91% |
| Pearson r | **0.916362** |
| R² | **0.839683** |
| 실측 평균 / 예측 평균 | 199.9975 / 199.9942 |
| 예측 min–max | 140.4831 – 232.3476 |

---

## 3. 한 줄

`reg_d90` 단독: MAE=3.7992, RMSE=4.8653, r=0.916362, R²=0.839683 · 현재 가중 1/11.
