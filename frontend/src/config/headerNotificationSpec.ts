 ...
 * and maps them into this shape. Read / dismiss state is stored in localStorage
 * (`kdt-header-notif-read`, `kdt-header-notif-dismissed`). A future
 * GET /api/notifications/summary can reuse the same types without changing UI shape.
 */
