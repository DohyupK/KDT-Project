...
| [`docs/`](./docs/) | 방향 · 일지 · 계획 · 스키마 참조 | [일지](./docs/work-log/2026-08-05.md) |
...
| [`docs/work-log/2026-08-05.md`](./docs/work-log/2026-08-05.md) | `cathode_*_data` 테이블 제거(임시) · score→`lots` · 후속 데이터 끼워넣기 메모 |
